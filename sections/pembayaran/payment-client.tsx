...
})
{
  ...
  if (loadingProject) {
    return (
      <main className="pt-32.5 pb-24 max-w-7xl mx-auto px-4 flex items-center justify-center min-h-[50vh]">
  ...
  if (loadError || !project) {
    return (
      <main className="pt-32.5 pb-24 max-w-7xl mx-auto px-4 flex flex-col items-center justify-center min-h-[50vh] gap-4">
  ...
  if (result) {
    return (
      <main className="pt-32.5 pb-24 max-w-7xl mx-auto px-4 flex flex-col items-center gap-6 text-center">
  ...
  // ── Form pembayaran ──
  return (
    <main className="pt-32.5 pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <Link
